...
<template>
    <div class="pb-6">
        <div class="relative inline-block">
            <img :src="normalizedMaterial.borderImagePath" alt="Border Image" class="absolute w-20 h-20"
                :class="{ 'w-36': normalizedMaterial.material === 'Sharpodonty' || normalizedMaterial.material === 'Dust' }" />
            <img :src="normalizedMaterial.itemImagePath" alt="Material Image" class="avatar w-20 h-20"
