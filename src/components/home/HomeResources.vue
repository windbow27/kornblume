...
const resources = [
    { name: 'Huiji wiki', author: 'Huiji wiki team', comment: t('very-detailed-most-of-the-data-is-from-this-wiki'), link: 'https://res1999.huijiwiki.com/wiki/%E9%A6%96%E9%A1%B5' },
    ...
    { name: 'ArkPlanner', author: 'Penguin Statistics', comment: t('referred-to-arkplanner-s-farming-route-algorithm-enhanced-with-linear-programming-magic'), link: 'https://penguin-stats.io/planner' },
