<template>
    <div class="responsive-spacer">
        ...
        <p class="text-white">If you encounter any unexpected issues with the site, you can reset your data.</p>
        <div class="flex justify-center items-center p-2">   
        ...
        <dialog id="my_modal_2" class="modal">
            <div class="modal-box custom-gradient-gray-blue">
                <p class="pb-4">Once you delete your data, there is no going back.</p>
                <p class="pb-4">Please be certain.</p>
                <button
                    @click="resetStores"
                    class="bg-red-500 hover:bg-red-700 text-white font-bold py-2 px-4 rounded ml-2 float-right">
                    Reset
                </button>
            </div>
...
<h2 class="text-2xl text-white font-bold my-4 lg:my-6">Danger Zone</h2>
        <p class="text-white">If you encounter any unexpected issues with the site, you can reset your data. Sorry for the inconvenience.</p>
        <div class="flex justify-center items-center p-2">
            <button onclick="my_modal_2.showModal()"
                class="bg-red-500 hover:bg-red-700 text-white font-bold py-2 px-4 rounded ml-2">
                Reset Data
